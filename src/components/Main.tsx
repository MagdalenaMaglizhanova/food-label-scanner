        ...
        <div className="container">
          ...
          <div className="features-grid">
            ...
            <div className="feature-card">
              ...
              <h3>Ползите за тялото</h3>
              <p>Проучванията показват, че биопродуктите често съдържат повече антиоксиданти и полезни вещества.</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="#4CAF50">
              ...
              <h3>Енергия за тялото, баланс за духа</h3>
              <p>Изберете продукти с висока хранителна стойност, за да подкрепят не само физическото ви здраве, но и духа ви</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <p>Интелигентно разпознаване на храни чрез камера</p>
            </div>
            <div className="feature-card">
              <div className="feature-icon">
                <svg width="40" height="40" viewBox="0 0 24 24" fill="#4CAF50">
            ...
            <div className="feature-card">
              ...
              <p>Проследявайте прием на храна и постигайте Вашите цели</p>
            </div>
          </div>
        </div>
      </section>
